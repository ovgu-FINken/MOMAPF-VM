...
class TBot:
    ...
    def test(self, update, context):
        ...
        parser.add_argument("-x", nargs=1, default="robustness", choices=["robustness", "time", "length"])
        parser.add_argument("-y", nargs=1, default="time", choices=["robustness", "time", "length"])
    ...
    def scatterplot(self, update, context):
        ...
        parser.add_argument("-y", default="time", choices=columns)
